...
async def start(bot, msg, cb=True):   
    txt=f"hey {msg.from_user.mention} iam powerfull file rename bot with personal usage.\nthis bot is made by <b><a href=https://github.com/Umyagurjar>Umesh</a></b>"                                     
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/ug_bot_updates")
        ],[
